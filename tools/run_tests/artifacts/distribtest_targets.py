...
def targets():
    ...
    return [
        ...
        RubyDistribTest(
            "linux", "x64", "alpine", ruby_version="ruby_3_1", presubmit=True
        ),
        RubyDistribTest(
            "linux", "x64", "alpine", ruby_version="ruby_3_2", presubmit=True
        ),
        RubyDistribTest(
            "linux", "x64", "alpine", ruby_version="ruby_3_3", presubmit=True
        ),
        RubyDistribTest(
            "linux", "x64", "alpine", ruby_version="ruby_3_4", presubmit=True
        ),
        # PHP8
